...
export const extractCollectionsIdentifiers = (labels: Labels) => ({
  collectionIds: getFilteredIdsOfLabels(
    labels,
    DisplayLabelPrefix.collectionID,
  ),
})

export const getFilteredIdsOfLabels = (
  labels: Labels,
  prefix: DisplayLabelPrefix,
): Identifiers =>
  labels
